...
import 'package:project_sec/pages/meeting/video_conference_page.dart';
          ...
          children: [
            Column(
              children: [
                Padding(
                  ...
                  child: Align(
                    ...
                    child: InkWell(
                      ...
                      child:
                          const Icon(Icons.arrow_back_ios_new_sharp, size: 25),
                    ),
                  ),
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_channelIdController.text.trim() != '' &&
                        _nameController.text != '') {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => VideoConferencePage(
                              conferenceID: _channelIdController.text.trim(),
